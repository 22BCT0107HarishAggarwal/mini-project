	...
	return (
		<main className="my-16 px-10 lg:px-32">
			<div className="flex justify-between my-16">
				<div>
					<span className="text-slate-400 inline-block mr-20">
						Home&nbsp;/&nbsp;Gaming&nbsp;/
					</span>
		...
		return (
			<div className="relative flex flex-col w-60 my-16">
				<img
					alt="Eye Icon"
					src={EyeIcon}
					className="absolute top-1 right-1 bg-white rounded-full p-1 hover:cursor-pointer w-8 aspect-square z-10"
				/>
